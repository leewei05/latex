...
(a) Given an array $A[1..10]=< 6,10,4,1,8,7,5,2,9,3>$, what is the resulting heap using the $\proc{BUILD-MAX-HEAP}(A)$ procedure listed in the textbook? You should show your result step by step, using Figure 6.3 in the textbook as a model. (b) Use Figure 6.4 as a model, illustrate the operation of $\proc{HEAPSORT}$ on the heap you built in (a).
\begin{solution}
